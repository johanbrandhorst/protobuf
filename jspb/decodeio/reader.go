...
// Reader encapsulates the decodeio.Reader.
...
func NewReader(data []byte) Reader {
	return &reader{
		Object: js.Global.Get("Reader").New(data),
	}
}
...
// Next is true as long as there hasn't been an error.
...
// SkipType skips the next element of the specified type.
func (r reader) SkipType(t int) {
	r.Call("skipType", t)
}
...
func (r *reader) ReadInt64() int64 {
	defer catchException(&r.err)
	return int64(r.Call("Int64").Int64())
}
...
func (r *reader) ReadUint32() uint32 {
	defer catchException(&r.err)
	return uint32(r.Call("Uint32").Int())
}
...
func (r *reader) ReadUint64() uint64 {
	defer catchException(&r.err)
	return uint64(r.Call("Uint64").Int())
}
...
func (r *reader) ReadSint32() int32 {
	defer catchException(&r.err)
	return int32(r.Call("Sint32").Int())
}
...
func (r *reader) ReadSint64() int64 {
	defer catchException(&r.err)
	return int64(r.Call("Sint64").Int())
}
...
func (r *reader) ReadFixed32() uint32 {
	defer catchException(&r.err)
	return uint32(r.Call("Fixed32").Int())
}
...
func (r *reader) ReadFixed64() uint64 {
	defer catchException(&r.err)
	return uint64(r.Call("Fixed64").Int())
}
...
func (r *reader) ReadSfixed32() int32 {
	defer catchException(&r.err)
	return int32(r.Call("Sfixed32").Int())
}
...
func (r *reader) ReadSfixed64() int64 {
	defer catchException(&r.err)
	return int64(r.Call("Sfixed64").Int())
}
...
func (r *reader) ReadFloat32() float32 {
	defer catchException(&r.err)
	return float32(r.Call("Float").Float())
}
...
func (r *reader) ReadBytes() []byte {
	defer catchException(&r.err)
	return r.Call("Bytes").Interface().([]byte)
}
